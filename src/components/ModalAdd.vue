            ...
            <div class="px-4">
              ...
              <div class="relative">
                <button
                  ...
                  class="bg-gray-50 border border-gray-300 rounded-lg p-2.5 w-full focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-600 dark:border-gray-500 text-left dark:focus:ring-primary-500 dark:focus:border-primary-500"
                >
